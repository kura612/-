...
経過日数と節約金額を、アプリを開かずにホーム画面で見られます。
iOS のウィジェットは Web アプリからは作れないため、無料アプリ [Scriptable](https://scriptable.app/) で動く
ウィジェットを `widget/smokefree-widget.js` に用意しました。導入手順は [widget/README.md](widget/README.md) を参照してください。
